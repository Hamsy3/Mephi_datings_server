...
def insert_users():
    try:
        ...
        cur.execute('INSERT INTO Interest(fixed_int_id, user_id) VALUES (%s, %s), (%s, %s), (%s, %s);', (1, user_id, 2, user_id, 4, user_id))
        cur.execute('INSERT INTO Requirement(fixed_req_id, user_id) VALUES (%s, %s), (%s, %s), (%s, %s);', (3, user_id, 4, user_id, 1, user_id))
        conn.commit()
        course = "9"
        for i in range(1,6):
        ...
        for i in range(16,21):
            ...
            cur.execute('INSERT INTO User_auth(user_id, login, password_hash) VALUES (%s, %s, %s);', (user_id, login, hashed_password))
            cur.execute('INSERT INTO User_data(user_id, grade, first_name, "group", course, is_man) VALUES (%s, %s, %s, %s, %s, true);', (user_id, grade,login, group, course))
            cur.execute('INSERT INTO Interest(fixed_int_id, user_id) VALUES (%s, %s), (%s, %s);', (3, user_id, 5, user_id))
            cur.execute('INSERT INTO Requirement(fixed_req_id, user_id) VALUES (%s, %s), (%s, %s);', (2, user_id, 5, user_id))
            conn.commit()
        return "Success"    
    except Exception as e:
        return  e
